...
for model_name, metrics in results.items():
    print(f"{model_name} - Mean Absolute Error: {metrics['MAE']:.2f}, Mean Squared Error: {metrics['MSE']:.2f}, R2 Score: {metrics['R2 Score']:.2f}")
...
## Output:
![alt text](<Screenshot 2026-03-09 115527.png>)
